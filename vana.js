...
class Vana {
    ...
    async processAccount(initData, hoinhiemvu, accountIndex) {
        try {
            ...
            if (playerData) {
                console.log(`========== Tài khoản ${accountIndex} | ${playerData.tgFirstName.green} ==========`);
            ...
            while (true) {
                const taskCompleted = await this.postTaskCompletion(initData, 1, (Math.random() * (900.0 - 500.0) + 500.0).toFixed(1));
